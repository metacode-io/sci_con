defmodule SciCon.Codegen.CODATA.Mappers.UniversalMapper do
  @moduledoc """
  ...
  use SciCon.Codegen.CODATA.Mapper, category: :universal
  ...
  group :planck_scale do
    ...
    constant "Planck constant", :h, :planck_constant, defined?: true
    constant "Planck constant in eV/Hz", :h_in_ev_hz, :planck_constant_in_ev_per_hz
    constant "reduced Planck constant", :hbar, :planck_constant_reduced, defined?: true
  ...
  group :relativistic do
    ...
    constant "speed of light in vacuum", :c, :speed_of_light, defined?: true
  end
